...
public:
     ...
     */
    inline size_t ensureCapacity(size_t nbytes) {
     ...
     */
    inline cb::const_byte_buffer rdata() const {
     ...
     */
    inline cb::byte_buffer wdata() const {
     ...
     */
    inline ssize_t produce(std::function<ssize_t(void* /* ptr */, size_t /* size */)>
                            producer) {
     ...
     * @return the number of bytes produced
     */
    inline ssize_t produce(std::function<ssize_t(cb::byte_buffer)> producer) {
        auto avail = getAvailableWriteSpace();
     ...
     */
    inline void produced(size_t nbytes) {
     ...
     */
    inline ssize_t consume(std::function<ssize_t(const void* /* ptr */,
     ...
     * @return the number of bytes consumed
     */
    inline ssize_t consume(std::function<ssize_t(cb::const_byte_buffer)> consumer) {
        auto avail = getAvailableReadSpace();
     ...
     * buffer)
     */
    inline void consumed(size_t nbytes) {
...
protected:
     ...
     */
    inline cb::byte_buffer getAvailableWriteSpace() const {
     ...
     */
    inline cb::const_byte_buffer getAvailableReadSpace() const {
